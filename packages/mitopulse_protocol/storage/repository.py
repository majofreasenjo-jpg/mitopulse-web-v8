...
def list_entities(limit=100): return list_rows("entities", limit)
def list_trust_profiles(limit=100): return list_rows("trust_profiles", limit)
def list_users(limit=100): return list_rows("users", limit)
def list_tenants(limit=100): return list_rows("tenants", limit)
