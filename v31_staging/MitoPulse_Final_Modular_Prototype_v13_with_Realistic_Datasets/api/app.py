...
def live_options():
    return {
        "validated_alerts": validated_alerts,
        "mutations": mutations,'connectors': list_live_configs()}
...
def detection_run():
    ...
    if target is None:
        return {
        "validated_alerts": validated_alerts,
        "mutations": mutations,'error': 'no dataset found in live_output or mapped data folders'}
    ...
    if not events_fp.exists():
        return {
        "validated_alerts": validated_alerts,
        "mutations": mutations,'error': f'events.csv not found in {target}'}
...
def demo_run(demo_id: str):
    ...
    if target is None:
        return {
        "validated_alerts": validated_alerts,
        "mutations": mutations,'error': 'no dataset found for demo execution'}
...
def simulation_playback():
    ...
    if target is None:
        return {
        "validated_alerts": validated_alerts,
        "mutations": mutations,'error': 'no dataset found for playback'}
